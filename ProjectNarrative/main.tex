...
%%%% Higgs Physics %%%%%%%%%%
\threehead{Higgs Physics (PI: Brandt, Hadavand, White)}

%%%% Sub-Subject: Charged Higgs %%%%%%%%%%
\fourhead{Charged Higgs (PI: Brandt, Hadavand)}
\input{Haleh/Charged-Higgs.tex}

%%%% Sub-Subject: Z+X Scan %%%%%%%%%%
\fourhead{Z+X Scan (PI: Hadavand)}
\input{Haleh/ZplusX.tex}

%%%% Sub-Subject: Higgs to invisible %%%%%%%%%%
\fourhead{Higgs Decays to Invisible Particles (PI: White)}
\input{White/EF_Higgs_to_Invisible.tex}

\threehead{SUSY Physics (PI: De, Farbin)}

\threehead{Tile HL-LHC Upgrade (PI: De, Farbin)}


\fourhead{Tile Low Voltage Power Supply(LVPS) Upgrade  (PI: Brandt, Hadavand)}
