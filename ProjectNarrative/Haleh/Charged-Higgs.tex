...
By using simulated \ttbar\ data instead of $\tau$ embedding~\cite{embedding} resulted in a paper with 3.2 \invfb\ of data and a conference note at 14.7\invfb\ of data at 13 TeV~\cite{taunu,hptnu1}.  This luminosity increase increased the mass reach of the analysis from 250 GeV in Run 1 to 600 GeV in Run 2.
...
Figure~\ref{fig:tau} (middle) shows that with the 2018 dataset of 100-150 Gev of data the analysis is only excluding large \tanb\ values so this analysis continues to be an important measurement as more data in accumulated.
