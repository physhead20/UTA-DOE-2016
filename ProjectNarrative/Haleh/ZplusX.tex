...
\paragraph{Determine Algorithm for Boosted/Collimated di-tau Pair Identification} %(April 2017)
...
\paragraph{Write General Analysis Suite for xAODs} %(April 2017)
...
\paragraph{Parameterize Background} %(D - 3 months) 
...
\paragraph{Perform two separate scans in Z final state} %(D - 4 months)
...
\paragraph{Develop and Optimize Bump-hunter to Scan Data} %(April '17)
