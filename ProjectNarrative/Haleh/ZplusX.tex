...
The search can be further expanded in a model-independent manner by scanning for Z+X where X can be of masses not theoretically motivated. 
...
This method is motivated but not limited to the final states listed in table~\ref{tab:anal}.
