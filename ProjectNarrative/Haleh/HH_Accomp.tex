...
\itam{FY17 - Hire new postdoc to work on charged Higgs and Z+X analyses.}
\itam{FY17-18 - Develop di-tau reconstruction algorithm.}
\itam{FY18 - Develop analysis suite for Z+X analysis.}
\itam{FY18 - Publish Z+X results using Higgs mass constraint.}
\itam{FY18 - Publish charged Higgs results using deep learning techniques for selection and/or tau reconstruction.}
\itam{FY18-19 - LVPS V8.2 prototype.}
\itam{FY18-19 - Testing and integration of LVPS into vertical slice test.}
