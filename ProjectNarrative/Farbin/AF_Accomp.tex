...
%% {\em General Plans and Milestones during previous funding period} (details 
...
%(i) Moriond 2017, covering the 2015+2016 dataset with up to 40
%fb-1. There are some publications that might slip into the summer
%2017 (based on ambitions and lack of manpower).  (ii) Paper using the
%entire Run 2 dataset, the timeline for this has not been discussed
%widely, as during 2017 there will be an update of software (Athena
%release 20 to 21, and the use of cmake), and there will be time to
%make the most out of this dataset.  Physics Coordination is against
%having intermediate CONF notes, but if there is some radical new
%approach it might be possible…
