...
\begin{table}[htb]
	...
	\hline
	     & protoDUNE SP-APA QA/QC and installation & UTA/CERN & Asaadi \\ \cline
	DUNE & BSM Physics & UTA & Yu \\ \cline
	     & protoDUNE DP-FC Construction & UTA/CERN & Yu \\ 
	\hline
	     & Cold Electronics TPC Test-stand & UTA/FNAL & Asaadi \\ \cline
        SBND & Detector Construction, Installation, and Commissioning & FNAL & Yu \\ \cline 	     
	     & Cross-Section Data Analysis & UTA/FNAL & Asaadi \\ 
	\hline
	ICARUS	  & Detector Installation and Commissioning & FNAL & Asaadi \\ \cline
		  & NuMI Off-Axis Cross-Sections $&$ Dark Matter Search & UTA/FNAL & Yu \\
	\hline
		   & TPC Detector Expert & UTA/FNAL & Asaadi \\ \cline
	MicroBooNE & Detector Operations & UTA/FNAL & Asaadi \\ \cline
	           & Cross-Section Data Analysis & UTA/FNAL & Asaadi \\
	\hline
	MiniBooNE & Beam Dump Dark Matter Search & UTA/FNAL & Yu \\
	\hline                      
	\end{tabular}}
	\caption{Overview of the UTA projects across the Intensity Frontier projects} \label{tab:IFProjects}
	\end{center}
\end{table}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\noindent \textbf{\underline{DUNE (Asaadi, Yu):}} The UTA group will be contributing to both the protoDUNE Dual Phase (DP) and Single Phase (SP) detectors. Asaadi and Yu expect to play a major role in various detector component construction, installation, and commissioning as well as data taking during the first two years of this proposal. This work will lay the strong foundation to contributing to the DUNE experiment and is described in greater detail in Section \ref{sec:IF_protoDUNE}. Along with this, UTA hopes to play a critical role in the physics profile for the DUNE experiment through contributions to the physics working groups.
