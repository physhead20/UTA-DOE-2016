...
In addition, for a strategic timeline of the contributions, Asaadi will focus on short and mid-term experiments MicroBooNE and SBND Ð with decreasing proportions of contributions to ICARUS and DUNE, while Yu will focus on long and mid-term experiments Ð DUNE and ICARUS Ð with decreasing proportion of contributions to SBND.  This strategy will help our group to maintain a certain, constant level of contributions spanning throughout all four experiments. 
...
A summary of the experiments, projects and PI's responsibilities is provided in Table \ref{tab:IFProjects}. The details of these projects are given in the subsequent sections.
